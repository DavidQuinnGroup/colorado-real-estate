...
export const MLS_GRID_MAX_MIN_DELAY_MS = 60000;
let lastRequestTime = 0;
let limiterChain = Promise.resolve();
function getBoundedDelayMs(value, fallback = MLS_GRID_DEFAULT_MIN_DELAY_MS) {
...
export async function rateLimit(delayMs = readMlsGridDelayMs()) {
    ...
    limiterChain = run.then(() => undefined, () => undefined);
    return run;
}
