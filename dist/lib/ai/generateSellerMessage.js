...
exports.generateSellerMessage = generateSellerMessage;
async function generateSellerMessage({ city, beds, price, reason, variant, touch = 1, }) {
    try {
        let style = "";
        // 🧪 VARIANTS
        if (variant === "A") {
...
function fallbackMessage({ city, reason, }) {
