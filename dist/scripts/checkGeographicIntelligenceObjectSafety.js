...
import { GIO_AUTHORIZED_OBJECT_TYPES, GIO_SAFE_ELIGIBILITY_DEFAULTS, assertGioAuthorizedObjectType, assertGioEffectiveDateRange, buildGioObjectIdempotencyKey, normalizeGioLookupValue, validateGioObjectCreateInput, } from "../lib/gio/persistence.js";
const schema = fs.readFileSync("prisma/schema.prisma", "utf8");
const migration = fs.readFileSync("prisma/migrations/20260725143000_gio_wave3_additive_persistence_foundation/migration.sql", "utf8");
...
console.log("[geographic-intelligence-object-safety] ok: additive GIO schema, five-type scope, safe eligibility defaults, duplicate protections, no geometry, no seeds/backfills, no runtime consumption, and property-protective referential behavior passed.");
