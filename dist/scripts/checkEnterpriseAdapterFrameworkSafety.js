...
console.log("[enterprise-adapter-framework-safety] ok: shared lifecycle, repository-specific source separation, live provenance, idempotency preservation, manual admin route, and forbidden activation checks passed.");
