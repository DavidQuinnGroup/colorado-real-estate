...
async function main() {
    ...
    console.log('[map-rendering-safety] ok: deterministic map pane visibility, native Leaflet tile reset, resize invalidation, and no decorative basemap overlays verified.');
}
main().catch((error) => {
