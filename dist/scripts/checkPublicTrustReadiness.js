...
console.log(`[public-trust-readiness] ok: ${routes.length} trust routes, shared brokerage attribution, Compass launch gate watch, footer links, sitemap inclusion, draft review status, listing attribution gaps, market source controls, owner-review register, and form notices verified.`);
