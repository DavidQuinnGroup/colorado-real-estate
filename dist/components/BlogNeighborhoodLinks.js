...
exports.default = BlogNeighborhoodLinks;
const link_1 = __importDefault(require("next/link"));
const neighborhoods_1 = require("@/lib/neighborhoods");
function BlogNeighborhoodLinks({ city }) {
    ...
    return (<section className="mt-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        {cityNeighborhoods.map((n) => (<link_1.default key={n.slug} href={`/neighborhood/${n.slug}`} className="border rounded-lg p-4 hover:bg-gray-50">
            {n.name}
          </link_1.default>))}
