    ...
    <main className="min-h-screen bg-[#071014] px-5 py-6 text-slate-100 sm:px-8 sm:py-8 lg:px-12" data-testid="agent-workspace-home" data-agent-only="true" data-persistence="false" data-customer-data="false" data-provider-activity="false">
      <div className="mx-auto max-w-6xl">
        <header className="max-w-3xl border-b border-white/10 pb-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">Choose what you want to prepare</h1>
        ...
        <section className="mt-8" aria-labelledby="agent-workspace-capabilities-heading">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 id="agent-workspace-capabilities-heading" className="mt-1 text-xl font-semibold text-white">Available capabilities</h2>
            </div>
            ...
            {preparationCapabilities.map((capability) => {
              ...
              return (
                <li key={capability.href}>
                  <Link href={capability.href} className="group flex min-h-56 h-full flex-col border border-white/10 bg-white/[0.035] p-5 text-left no-underline transition hover:border-cyan-100/35 hover:bg-cyan-100/[0.06] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-100" data-testid="agent-workspace-capability-link" data-agent-workspace-capability={capability.href}>
