...
import { ChevronDown, ClipboardList, FileSearch, Landmark, ShieldCheck } from 'lucide-react';
...
export default function AgentBriefingComposition({ briefing }: { briefing: AgentBriefingCompositionModel }) {
