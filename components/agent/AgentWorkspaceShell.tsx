    ...
    <header className="border-b border-white/10 bg-[#071014]" data-testid="agent-workspace-navigation">
      <nav className="mx-auto max-w-7xl px-5 py-3 sm:px-8 lg:px-12" aria-label="Agent workspace navigation"><div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-1">
          ...
          <Link href="/agent/logout?next=/agent" className="inline-flex min-h-10 items-center gap-2 rounded-[7px] border border-white/15 px-3 py-2 text-xs font-semibold text-slate-200 transition hover:border-white/30 hover:bg-white/[0.06] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-100"><LogOut size={15} aria-hidden="true" />Sign out</Link>
        </div>
      </div></nav>
    </header>
