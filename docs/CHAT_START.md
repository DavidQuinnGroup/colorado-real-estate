...
- Checkpoint 1320 is the current checkpoint with message `Document strict notification contract refresh`.
...
- No intended dirty files should remain after Checkpoint 1320 is committed; `.env.local` remains gitignored and must not be committed.
