...
- Checkpoint 1370 is the current checkpoint with message `Document Typesense collections readiness refresh`.
...
- No intended dirty files should remain after Checkpoint 1370 is committed; `.env.local` remains gitignored and must not be committed.
