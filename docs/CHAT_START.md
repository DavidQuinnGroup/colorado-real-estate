...
- Checkpoint 1082 is the current `main` commit with message `Document queue dashboard after sender readiness`.
...
- No intended dirty files remain after Checkpoint 1082; `.env.local` remains gitignored and must not be committed.
