...
- Checkpoint 1330 is the current checkpoint with message `Document production build refresh`.
...
- No intended dirty files should remain after Checkpoint 1330 is committed; `.env.local` remains gitignored and must not be committed.
