...
- Checkpoint 1093 is the current `main` commit with message `Document saved search alert dry run preview`.
...
- No intended dirty files remain after Checkpoint 1093; `.env.local` remains gitignored and must not be committed.
