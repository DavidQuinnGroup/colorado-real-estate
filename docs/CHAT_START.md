...
- Checkpoint 1106 is the current `main` commit with message `Document production build refresh`.
...
- No intended dirty files remain after Checkpoint 1106; `.env.local` remains gitignored and must not be committed.
