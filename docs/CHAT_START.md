...
- Checkpoint 1101 is the current `main` commit with message `Document launch readiness after CRM refresh`.
...
- No intended dirty files remain after Checkpoint 1101; `.env.local` remains gitignored and must not be committed.
