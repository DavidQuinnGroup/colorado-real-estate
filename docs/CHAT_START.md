...
- Checkpoint 1088 is the current `main` commit with message `Document production build after fast verification`.
...
- No intended dirty files remain after Checkpoint 1088; `.env.local` remains gitignored and must not be committed.
