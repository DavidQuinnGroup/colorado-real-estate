...
- Checkpoint 1097 is the current `main` commit with message `Document fast verification refresh`.
...
- No intended dirty files remain after Checkpoint 1097; `.env.local` remains gitignored and must not be committed.
