...
- Checkpoint 1289 is the current checkpoint with message `Document runtime smoke refresh`.
...
- No intended dirty files remain after Checkpoint 1289; `.env.local` remains gitignored and must not be committed.
