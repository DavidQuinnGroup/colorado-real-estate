...
- Checkpoint 1288 is the current checkpoint with message `Document production build refresh`.
...
- No intended dirty files remain after Checkpoint 1288; `.env.local` remains gitignored and must not be committed.
