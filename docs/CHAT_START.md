...
- Checkpoint 1105 is the current `main` commit with message `Document fast verification refresh`.
...
- No intended dirty files remain after Checkpoint 1105; `.env.local` remains gitignored and must not be committed.
