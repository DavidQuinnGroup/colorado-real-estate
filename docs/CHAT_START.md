...
- Checkpoint 1085 is the current `main` commit with message `Document strict notification readiness after alert dry run`.
...
- No intended dirty files remain after Checkpoint 1085; `.env.local` remains gitignored and must not be committed.
