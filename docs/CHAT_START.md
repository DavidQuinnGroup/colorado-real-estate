...
- Checkpoint 1108 is the current `main` commit with message `Document Supabase and Typesense readiness refresh`.
...
- No intended dirty files remain after Checkpoint 1108; `.env.local` remains gitignored and must not be committed.
