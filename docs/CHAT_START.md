...
- Checkpoint 1343 is the current checkpoint with message `Document runtime smoke refresh`.
...
- No intended dirty files should remain after Checkpoint 1343 is committed; `.env.local` remains gitignored and must not be committed.
