...
- Checkpoint 1273 is the current checkpoint with message `Document notification readiness refresh`.
...
- No intended dirty files remain after Checkpoint 1273; `.env.local` remains gitignored and must not be committed.
