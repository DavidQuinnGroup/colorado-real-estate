...
- Checkpoint 1096 is the current `main` commit with message `Document strict notification contract refresh`.
...
- No intended dirty files remain after Checkpoint 1096; `.env.local` remains gitignored and must not be committed.
