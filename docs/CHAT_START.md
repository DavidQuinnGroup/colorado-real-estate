...
- Checkpoint 1099 is the current `main` commit with message `Document runtime smoke after production build`.
...
- No intended dirty files remain after Checkpoint 1099; `.env.local` remains gitignored and must not be committed.
