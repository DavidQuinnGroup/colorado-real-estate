...
Your job is to provide a single copy/paste format that extracts, organizes, and normalizes EVERYTHING important from this conversation so it can be reused in future chats with zero context loss. Make any updates to this list as needed. Start with
==============================
PROJECT BRAIN — CONTEXT CAPTURE
==============================
