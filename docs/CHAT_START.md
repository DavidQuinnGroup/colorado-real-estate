...
- Checkpoint 1325 is the current checkpoint with message `Document saved search alert readiness refresh`.
...
- No intended dirty files should remain after Checkpoint 1325 is committed; `.env.local` remains gitignored and must not be committed.
