...
- Checkpoint 1298 is the current checkpoint with message `Document fast verification refresh`.
...
- No intended dirty files remain after Checkpoint 1298; `.env.local` remains gitignored and must not be committed.
