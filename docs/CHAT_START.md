...
- Checkpoint 1353 is the current checkpoint with message `Document fast verification refresh`.
...
- No intended dirty files should remain after Checkpoint 1353 is committed; `.env.local` remains gitignored and must not be committed.
