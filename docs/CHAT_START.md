...
- Checkpoint 1278 is the current checkpoint with message `Document runtime smoke refresh`.
...
- No intended dirty files remain after Checkpoint 1278; `.env.local` remains gitignored and must not be committed.
