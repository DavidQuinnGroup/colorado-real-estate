...
- Checkpoint 1369 is the current checkpoint with message `Document Supabase readiness refresh`.
...
- No intended dirty files should remain after Checkpoint 1369 is committed; `.env.local` remains gitignored and must not be committed.
