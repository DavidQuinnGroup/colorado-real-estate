...
- Checkpoint 1104 is the current `main` commit with message `Document strict notification contract refresh`.
...
- No intended dirty files remain after Checkpoint 1104; `.env.local` remains gitignored and must not be committed.
