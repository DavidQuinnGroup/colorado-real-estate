...
- Checkpoint 1344 is the current checkpoint with message `Document Supabase and Typesense readiness refresh`.
...
- No intended dirty files should remain after Checkpoint 1344 is committed; `.env.local` remains gitignored and must not be committed.
