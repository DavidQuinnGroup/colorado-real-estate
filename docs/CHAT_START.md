...
- Checkpoint 1321 is the current checkpoint with message `Document queue dashboard readiness refresh`.
...
- No intended dirty files should remain after Checkpoint 1321 is committed; `.env.local` remains gitignored and must not be committed.
