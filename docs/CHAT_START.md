...
- Checkpoint 1084 is the current `main` commit with message `Document alert dry run after aggregate readiness`.
...
- No intended dirty files remain after Checkpoint 1084; `.env.local` remains gitignored and must not be committed.
