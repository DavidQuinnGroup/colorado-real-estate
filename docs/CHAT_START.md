...
- Checkpoint 1087 is the current `main` commit with message `Document fast verification after strict contract`.
...
- No intended dirty files remain after Checkpoint 1087; `.env.local` remains gitignored and must not be committed.
