...
- Checkpoint 1276 is the current checkpoint with message `Document fast verification refresh`.
...
- No intended dirty files remain after Checkpoint 1276; `.env.local` remains gitignored and must not be committed.
