...
- Checkpoint 1086 is the current `main` commit with message `Document strict notification contract after alert dry run`.
...
- No intended dirty files remain after Checkpoint 1086; `.env.local` remains gitignored and must not be committed.
