...
- Checkpoint 1291 is the current checkpoint with message `Document CRM pending readiness refresh`.
...
- No intended dirty files remain after Checkpoint 1291; `.env.local` remains gitignored and must not be committed.
