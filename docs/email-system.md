...
- Production/deployment env still needs `PROPERTY_INQUIRY_NOTIFY_TO` or fallback `REIE_INTERNAL_EMAIL` configured before relying on live property-inquiry notification delivery, recurring alert sends, digest sends, or recurring email traffic.
