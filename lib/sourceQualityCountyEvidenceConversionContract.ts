...
} from './sourceQualityCountyAssessorExactSourceDefinitions';
import {
  ADAMS_COUNTY_ASSESSOR_SOURCE_ID,
  ARAPAHOE_COUNTY_ASSESSOR_SOURCE_ID,
  BOULDER_COUNTY_ASSESSOR_SOURCE_ID,
...
const SOURCE_CLASSES: Record<(typeof COUNTY_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS)[number], CountySourceQualityConversionSourceClass> = {
  ...
  'SRC-ARAPAHOE-COUNTY-TREASURER': 'COUNTY_TREASURER',
  'SRC-ADAMS-COUNTY-TREASURER': 'COUNTY_TREASURER',
...
export const ADAMS_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST = Object.freeze<CountySourceQualityEvidenceConversionRequest>({
  schemaVersion: SOURCE_QUALITY_COUNTY_EVIDENCE_CONVERSION_SCHEMA_VERSION,
  ...
  evidenceReferences: [{
    sourceId: ADAMS_COUNTY_ASSESSOR_SOURCE_ID,
    inputClass: 'CERTIFICATION_REFERENCE',
    evidenceReferenceId: 'COUNTY-ADAMS-ASSESSOR-CERT-001',
    posture: 'REFERENCED',
    verificationStatus: 'VERIFIED',
    limitationCodes: [],
  }],
  certificationReference: {
    certificationId: 'CERT-ADAMS-COUNTY-ASSESSOR-CONVERSION-001',
    repositoryReference: 'docs/project-atlas/executive-library',
    referenceVersion: 'V01',
