...
export const MARKET_DOM_BASES = [
  ...
  'AVERAGE_CDOM',
  'MEDIAN_CDOM',
  'DAYS_SINCE_LISTING_CONTRACT_DATE',
...
export const MARKET_METRIC_DEFINITIONS = Object.freeze({
  ...
  DAYS_SINCE_LISTING_CONTRACT_DATE_CANDIDATE: Object.freeze({
    metricDefinitionId: 'atlas.ires.days-since-listing-contract-date.candidate.v1',
    canonicalName: 'Days since listing contract date',
    displayLabel: 'Days since listing contract date',
    metricFamily: 'DAYS_ON_MARKET',
    sourceFamily: 'IRES',
    sourceConcept: 'ListingContractDate',
    unit: 'Elapsed days',
    aggregationMethod: null,
    populationDefinition: 'Single listing observation with an admitted ListingContractDate and explicit evaluation/as-of timestamp.',
    listingStatusScope: 'Status-specific populations are not admitted by this candidate.',
    propertyTypeScope: null,
    geographicScope: null,
    timeBasis: 'POINT_IN_TIME',
    periodDefinition: null,
    priceBasis: 'NOT_APPLICABLE',
    domBasis: 'DAYS_SINCE_LISTING_CONTRACT_DATE',
    activityConcept: 'NOT_APPLICABLE',
    calculationMethodVersion: 'ATLAS_DAYS_SINCE_LISTING_CONTRACT_DATE_CANDIDATE_V1',
    sourceMethodologyReference: 'IRES_PROJECT_MANAGER_ACACIA_2026_08_27_LISTING_CONTRACT_DATE_GUIDANCE',
    semanticStatus: 'PARTIALLY_DEFINED',
    admissionStatus: 'ADMITTED_FOR_LIMITED_USE',
    historicalComparisonStatus: 'NOT_ADMITTED',
    freshnessContract: 'A calculation must identify the explicit evaluation/as-of timestamp; no runtime calculation is activated by this definition.',
    limitations: Object.freeze([
      'Admitted only as an ATLAS-defined metric candidate based on elapsed days from ListingContractDate.',
      'Provider-equivalent DOM, IRES Average DOM, CDOM, relist/reset handling, off-market treatment, pending treatment, sold treatment, and population equivalence remain held.',
      'The supplied DaysOnMarket field remains non-authoritative reference evidence and is not the basis for this candidate.',
    ]),
    prohibitedInterpretations: defaultProhibitions,
    allowedUses: Object.freeze(['DISPLAY_RAW_OBSERVATION', 'AGENT_PREPARATION'] as const),
  } satisfies MarketMetricDefinition),
