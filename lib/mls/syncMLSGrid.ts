...
export type NormalizedSyncOptions = Required<Omit<SyncMLSGridOptions, 'startPage' | 'includeMedia'>> &
  Pick<SyncMLSGridOptions, 'startPage' | 'includeMedia'>;

export type SyncMLSGridPlan = NormalizedSyncOptions & {
  initialPage: number;
  includeMedia: boolean;
  terminal: 'Terminal 5';
...
export function getSyncMLSGridPlan(options: SyncMLSGridOptions = {}, stateLastPage = 0): SyncMLSGridPlan {
