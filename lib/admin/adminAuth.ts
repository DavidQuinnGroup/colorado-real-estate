...
export function sanitizeAgentReturnPath(value: string | null | undefined) {
  return value === '/agent' || value === '/agent/prepare/market' || value === '/agent/prepare/market-update' || value === '/agent/prepare/property' || value === '/agent/prepare/place' || value === '/agent/prepare/buyer' || value === '/agent/prepare/seller' || value === '/agent/prepare/seller/presentation' || value === '/agent/prepare/professional-inputs' || value === '/agent/prepare/listing' ? value : '/agent';
}
