...
export const agentWorkspaceNavigation: AgentNavigationItem[] = [
  ...
  { key: 'intelligence', label: 'Intelligence', href: '/agent/prepare', type: 'WORK_DOMAIN', active: (pathname) => ['/agent/prepare', '/agent/prepare/market', '/agent/prepare/market-update', '/agent/prepare/place', '/agent/prepare/property'].includes(pathname) },
