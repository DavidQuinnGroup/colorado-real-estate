...
export const NIWOT_GOVERNANCE_ONLY_RECONCILIATION = Object.freeze({
  status: "GOVERNANCE_ONLY_RECONCILED",
  authoritativeCandidateId: "wave2-niwot-non-activation-guard",
  canonicalObjectId: "unincorporated-community:boulder-county:niwot",
  canonicalName: "Niwot",
  objectType: "UNINCORPORATED_COMMUNITY",
  internalSlug: "niwot",
  parentObjectIds: Object.freeze(["county:boulder"]),
  contextualObjectIds: Object.freeze(["city:boulder", "city:longmont"]),
  contextualRelationshipBoundary: "Boulder and Longmont are surrounding market context only, not municipal identity or public activation authority.",
  publicActivationStatus: "NOT_ACTIVATED",
  routeEligibility: "BLOCKED",
  registryPublicEligibility: "PUBLIC_ACTIVATION_PROHIBITED",
  searchEligibility: "UNRESOLVED_AND_INACTIVE",
  mapGisEligibility: "BLOCKED_AND_INACTIVE",
  localDecisionIntelligenceEligibility: "PAUSED_AND_UNAUTHORIZED",
  localDecisionIntelligenceBoundary: "Local Decision Intelligence Wave 4 remains paused and unauthorized.",
  evidenceMaturity: "UNRESOLVED_INSUFFICIENT_FOR_PUBLIC_ACTIVATION",
  sourceRightsPosture: "UNKNOWN_OR_UNRESOLVED",
  legacyCompatibilityRecords: Object.freeze([
    "data/cities.ts",
    "lib/cities.ts",
  ...
  legacyTreatment: "Legacy city-style and market-route records are retained only as compatibility or fail-closed records and are non-authoritative for public activation.",
  gunbarrelTreatment: "UNCHANGED_SEPARATE_BLOCKED_GOVERNANCE_OBJECT",
  protectedBoundaries: Object.freeze({
    publicRouteCreated: false,
    routeEligibilityChanged: false,
    registryEligibilityChanged: false,
    searchActivated: false,
    mapGisActivated: false,
    localDecisionIntelligenceWave4Activated: false,
    providerOrAcquisitionActivated: false,
    persistenceChanged: false,
    productionBehaviorChanged: false,
    gunbarrelChanged: false,
  }),
} as const);
