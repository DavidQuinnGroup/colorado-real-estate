...
export const COUNTY_GEOSPATIAL_SOURCE_QUALITY_CONVERSION_FIREWALL = Object.freeze({
  ...
  parcelAcceptance: 'PARCEL_GEOMETRY_SOURCE_NOT_ACCEPTED_WITHOUT_SEPARATE_AUTHORIZATION',
});

const SOURCE_CLASSES: Record<(typeof COUNTY_GEOSPATIAL_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS)[number], Exclude<CountyGeospatialSourceQualityConversionSourceClass, 'COUNTY_GIS_PARCEL_GEOMETRY'>> = {
