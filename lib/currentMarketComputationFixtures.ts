...
export const CURRENT_MARKET_COMPUTATION_FIXTURE: CurrentMarketComputationInput = Object.freeze({
  sourceSetId: 'FIXTURE_CURRENT_PROPERTY_SOURCE_SET_2026_08_21',
  ...
  listings: Object.freeze([
    ...
    { mlsId: 'X-003', status: 'Active', city: 'Boulder', zip: '80302', propertyType: 'Condo', listPrice: 700_000, sqft: 900, sourceModifiedAt: '2026-08-15T10:00:00.000Z' },
  ]),
});
