...
export async function POST(request: NextRequest) {
  ...
  return new NextResponse(new Uint8Array(result.pdfBytes), {
    ...
    headers: {
      ...
      'X-Atlas-Pdf-Structural-Qa-Engine': result.structuralQa.engineVersion,
      'X-Atlas-Pdf-Structural-Qa-Parser': result.structuralQa.parserVersion,
      'X-Atlas-Pdf-Qa-Profile': `${result.structuralQa.profileId}:${result.structuralQa.profileVersion}`,
