...
export async function middleware(request: NextRequest) {
  ...
  const isAgentProtectedApiRoute = pathname === "/api/agent/client-authorizations" || pathname === "/api/agent/client-cases" || pathname === "/api/agent/client-case-context" || pathname === "/api/agent/client-case-scenario-financial-context" || pathname === "/api/agent/transactions" || pathname === "/api/agent/outputs" || pathname === "/api/agent/output/pdf" || pathname === "/api/agent/evidence" || pathname === "/api/agent/professional-inputs" || pathname === "/api/agent/professional-external-requests" || pathname === "/api/agent/seller-financial" || pathname === "/api/agent/multi-property-financial-scenarios";
...
export const config = {
  matcher: ['/((?!_next/).*)', "/admin/:path*", "/api/admin/:path*", "/api/agent/client-authorizations", "/api/agent/client-cases", "/api/agent/client-case-context", "/api/agent/client-case-scenario-financial-context", "/api/agent/transactions", "/api/agent/outputs", "/api/agent/output/pdf", "/api/agent/evidence", "/api/agent/professional-inputs", "/api/agent/professional-external-requests", "/api/agent/seller-financial", "/api/agent/multi-property-financial-scenarios", "/agent/:path*"],
};
