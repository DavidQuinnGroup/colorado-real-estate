...
import {
  ...
  DECISION_SCORING_RULES,
  HUMAN_DECISION_REQUIRED,
  buildDecisionSupportSnapshot,
  getDecisionPackage,
  getDecisionPackageComparison,
  getDecisionPackageExpectedOutcomes,
  getDecisionPackageRecommendation,
  getDecisionPackages,
  getDecisionSituations,
  validateDecisionCriteriaWeights,
...
console.log(
  "[enterprise-decision-support-safety] ok: situations, packages, scoring, recommendations, outcomes, traceability, auth, UI, fixture labels, human-review labels, and mutation boundaries passed.",
);
