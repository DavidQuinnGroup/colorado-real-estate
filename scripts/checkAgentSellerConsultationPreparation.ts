...
const allTopics = ["SELLING_PROCESS", "TIMING", "PROPERTY_CONDITION_PREPARATION", "PRICING_DISCUSSION", "CURRENT_MARKET_QUESTIONS", "PROPERTY_FACTS_RECORDS", "SHOWING_LAUNCH_PREPARATION", "SELLER_PROCEEDS_FINANCIAL_QUESTIONS", "OFFER_REVIEW_PROCESS", "DECISION_PROCESS", "REPRESENTATION_BROKERAGE_PROCESS", "PROFESSIONAL_QUESTIONS"] as const;
for (const priorities of [AGENT_SELLER_PREPARATION_FIXTURE.priorities.slice(0, 2), AGENT_SELLER_PREPARATION_FIXTURE.priorities, ["SELLING_PROCESS", "TIMING", "PROPERTY_CONDITION_PREPARATION", "PRICING_DISCUSSION", "CURRENT_MARKET_QUESTIONS", "PROPERTY_FACTS_RECORDS"] as const, allTopics]) assert.equal(buildAgentSellerPreparationPacket({ ...AGENT_SELLER_PREPARATION_FIXTURE, priorities }).admission, "ADMITTED");
