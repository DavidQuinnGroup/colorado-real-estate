...
const externalLayout = readFileSync('app/professional-request/layout.tsx', 'utf8');
...
assert.match(bootstrapResponse, /Return to David Quinn Group/);
...
assert.match(externalResponseForm, /ProjectAtlasPublicHomeAction terminal/);
assert.match(externalLayout, /ProjectAtlasExternalShell/);
assert.match(bootstrapRoute, /createProjectAtlasExternalUnavailableResponse/);
