...
assert.match(bootstrapRoute, /meta http-equiv="refresh"/);
assert.match(bootstrapRoute, /RESPONSE_PATH = '\/professional-request\/respond'/);
assert.doesNotMatch(bootstrapRoute, /NextResponse\.redirect/);
assert.match(bootstrapRoute, /response\.cookies\.set\('project_atlas_external_request_session'/);
