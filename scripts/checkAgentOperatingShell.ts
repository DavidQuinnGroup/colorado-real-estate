...
assert(agentShell.includes('href="/agent/prepare/market-update"'), 'Market Update Preparation must be an exact Agent navigation destination.');
...
assert(middleware.includes('pathname === "/agent/prepare/market-update"'), 'exact Market Update route login protection must remain');
