...
async function assertMarketNeighborhoodLinksSource() {
  ...
  assert.ok(source.includes('data-market-neighborhood-evidence-context='), 'Expected market neighborhood links to expose public evidence context.');
...
async function assertCityMarketStatsSource() {
  ...
  assert.ok(source.includes('data-city-market-health-state='), 'Expected city market stats to expose market health state metadata.');
  assert.ok(source.includes('data-city-market-access-context='), 'Expected city market stats to expose access context metadata.');
  assert.ok(source.includes('data-city-market-pressure='), 'Expected city market stats to expose pressure labels.');
  assert.ok(source.includes('data-city-market-access-context-label='), 'Expected city market stats to expose access context labels.');
  ...
  assert.ok(source.includes('data-city-market-negotiation-context='), 'Expected city market stats to expose negotiation context.');
  ...
  assert.ok(source.includes('data-city-market-pulse-access-context='), 'Expected city market stats to expose pulse access context.');
...
async function assertCityMarketSchemaSource() {
  ...
  assert.ok(source.includes('data-city-market-schema-health-state={marketExperience.directionLabel}'), 'Expected city market schema to expose market health state.');
  assert.ok(source.includes('data-city-market-schema-access-context="available"'), 'Expected city market schema to expose access context availability.');
...
async function assertNearbyNeighborhoodAuthoritySource() {
  ...
  assert.ok(source.includes('data-nearby-neighborhood-primary-anchor='), 'Expected nearby neighborhoods to expose primary anchors.');
  assert.ok(source.includes('data-nearby-neighborhood-evidence-context='), 'Expected nearby neighborhoods to expose public evidence context.');
...
async function assertCityNeighborhoodsSource() {
  ...
  assert.ok(source.includes('data-city-neighborhood-evidence-context='), 'Expected city neighborhoods to expose public evidence context.');
