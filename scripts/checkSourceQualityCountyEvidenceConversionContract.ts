...
assert.equal(COUNTY_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS.includes(LARIMER_COUNTY_TREASURER_SOURCE_ID), true);
assert.equal(COUNTY_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS.includes(BROOMFIELD_COUNTY_TREASURER_SOURCE_ID), true);
assert.equal(COUNTY_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS.includes(DOUGLAS_COUNTY_TREASURER_SOURCE_ID), true);
assert.equal(COUNTY_SOURCE_QUALITY_CONVERSION_ALLOWED_SOURCE_IDS.includes(WELD_COUNTY_TREASURER_SOURCE_ID), true);
...
const broomfieldTreasurerRequest = {
  ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST,
  ...
  evidenceReferences: [{ ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.evidenceReferences[0]!, sourceId: BROOMFIELD_COUNTY_TREASURER_SOURCE_ID }],
  reviewedAt: '2026-08-17',
  certificationReference: { ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.certificationReference!, linkageReviewedDate: '2026-08-17' },
} as const;
assert.equal(convertCountyStructuredEvidence(broomfieldTreasurerRequest).classification, 'COUNTY_EVIDENCE_CONVERSION_VALID');
const douglasTreasurerRequest = {
  ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST,
  ...
  evidenceReferences: [{ ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.evidenceReferences[0]!, sourceId: DOUGLAS_COUNTY_TREASURER_SOURCE_ID }],
  reviewedAt: '2026-08-17',
  certificationReference: { ...BROOMFIELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.certificationReference!, linkageReviewedDate: '2026-08-17' },
} as const;
assert.equal(convertCountyStructuredEvidence(douglasTreasurerRequest).classification, 'COUNTY_EVIDENCE_CONVERSION_VALID');
...
assert.equal(convertCountyStructuredEvidence({
  ...
  evidenceReferences: [{ ...LARIMER_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.evidenceReferences[0]!, sourceId: LARIMER_COUNTY_TREASURER_SOURCE_ID }],
}).classification, 'COUNTY_EVIDENCE_SOURCE_MISMATCH');
...
assert.equal(convertCountyStructuredEvidence({
  ...
  evidenceReferences: [{ ...WELD_COUNTY_ASSESSOR_SYNTHETIC_CONVERSION_REQUEST.evidenceReferences[0]!, sourceId: WELD_COUNTY_TREASURER_SOURCE_ID }],
}).classification, 'COUNTY_EVIDENCE_SOURCE_MISMATCH');
