...
assert.match(preparationStyles, /\.workspace > \.consultationSetup \{[\s\S]*?background: transparent;[\s\S]*?box-shadow: none;/, 'Buyer/Seller Consultation Setup must integrate with the page canvas rather than form a large structural card.');
