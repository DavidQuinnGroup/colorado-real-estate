...
console.log(
  `[public-trust-readiness] ok: ${routes.length} trust routes, footer links, sitemap inclusion, draft review status, owner-review register, and form notices verified.`,
);
